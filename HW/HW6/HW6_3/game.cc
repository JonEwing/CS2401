...
// this function.	
	...
	return winning();
     ...
     void game::set_search(){
     	int i;
     	cout<<"Pick a difculty. (1 hard - 4 easy)\n";
     	cin>> i;
     	while(i>4)
     	{
     		cout<<"Not Valid\n";
    ...
    void game::make_human_move( ){	
		...
		if(hold %2 == 0){
		cout<<"Enter your move BLACK (ex. A1)\n";
		}
		if(hold %2 == 1){
		cout<<"Enter your move WHITE(ex. A1)\n";
		}
		move = get_user_move( );
	...
	no_move_made = 0;
    	...
    	cout<<"Sorry, No legal moves for you.\n";
    	no_move_made++;
    	return;
        }
    }
